...
- Blogs
	...
	* [Davidwalsh.name - JavaScript](https://davidwalsh.name)
	* [RisingStack - JavaScript, DevOps, Microservices & Kubernetes](https://blog.risingstack.com)
	* [Nicolás Bevacqua - JavaScript Posts](https://ponyfoo.com/articles)
	* [Jake Archibald - JavaScript Posts](https://jakearchibald.com)
	* [WebDev - Beto Muniz](https://betomuniz.com/blog)
	* [udgwebdev - Caio Ribeiro Pereira - Posts Web Dev](https://udgwebdev.com/menu)
	* [Bitsofco.de - Frontend Posts](https://bitsofco.de)
	* [Alligator.io - JavaScript Posts](https://alligator.io/js)
	* [Douglas Crockford - JavaScript Posts](https://www.crockford.com/javascript/encyclopedia)
...
- eBooks Online
	...
	* [The Expressjs Handbook](https://drive.google.com/drive/folders/1aact9oGi51WNTxU-fwOyjc7B5Rq5H6Un)
	* [The Vuejs Handbook](https://drive.google.com/drive/folders/1tyTNux2-az1yn-PsT8k7OOZTcRCBIb92)
	* [The Reacjs Handbook](https://drive.google.com/drive/folders/1V7r9p8ERnJg6kL8cc8WG0haI03YSLqly)
	* [Nicolás Bevacqua - JavaScript](https://ponyfoo.com/books)
	* [Exploring ReasonML - Dr. Axel Rauschemayer](http://reasonmlhub.com/exploring-reasonml)
	* [Exploring JS: JavaScript books for programmers - Dr. Axel Rauschmayer](http://exploringjs.com)
	* [Designing for Performance - By Lara Callender Hogan](http://designingforperformance.com)
	* [JavaScript Awesome Tips - pt-BR](https://leanpub.com/javascript-awesome-tips-br-version/read_sample)
	* [Eloquent JavaScript](http://braziljs.github.io/eloquente-javascript)
	* [Daylerees - eBooks PHP](https://daylerees.com/books)
	* [Exercícios de Lógica e Livro de POO em Java (ótimo livro)](http://tiagodemelo.info/livros)
	* [Cryptobook - Practical Cryptography for Developers - by Svetlin Nakov](https://cryptobook.nakov.com)
	* [Programming and Programming Languages, by Shriram Krishnamurthi](https://papl.cs.brown.edu/2018)
	* [The C Book, GBdirect publications](http://publications.gbdirect.co.uk/c_book)
	...
	* [Runestone Interactive - Livros (Java, Python) Online em Inglês](http://interactivepython.org/runestone/default/user/login?_next=/runestone/default/index)
	* [Tradução do livro “How to Think Like a Computer Scientist: Interactive Version”, de Brad Miller e David Ranum](https://panda.ime.usp.br/pensepy/static/pensepy/index.html)
	* [Algoritmos em Python](http://www.algoritmosempython.com.br)
...
- Conteúdo disponibilizado por Universidades e Professores
	* [Programação em Java - Alexandre L. Rangel](https://sites.google.com/site/alexandrelrangel/Home/programacao-em-java)
	...
	* [Algoritmos, MySQL, C, Python, Metodologia do Ensino, POO](http://www3.ifrn.edu.br/~diegonascimento/dokuwiki/doku.php)
	* [Introdução a Computação - Assuntos em tópicos](https://www.ime.usp.br/~elo/IntroducaoComputacao)
	* [Materiais para cursos C, Java e Python](https://panda.ime.usp.br/panda)
	* [Princípios de Desenvolvimento de Algoritmos em Python](https://panda.ime.usp.br/algoritmos/static/algoritmos/index.html)
